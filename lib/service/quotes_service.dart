...
class QuotesService {
  static final List<Map<String, String>> _quotes = [
    ...
    {
      'quote': 'La productivité n\'est jamais un accident. C\'est le résultat d\'un engagement envers l\'excellence.',
      'author': 'Paul J. Meyer'
    },
    {
    ...
    {
      'quote': 'Vous n\'avez pas à être génial pour commencer, mais vous devez commencer pour être génial.',
      'author': 'Zig Ziglar'
    },
    {
      'quote': 'Une tâche à la fois, un jour à la fois. C\'est ainsi que l\'on avance.',
      'author': 'Anonyme'
    },
    {
    ...
    {
      'quote': 'Les grandes choses ne sont jamais faites par une seule personne. Elles sont faites par une équipe.',
      'author': 'Steve Jobs'
    },
  ];
